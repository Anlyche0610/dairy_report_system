...
public abstract class ActionBase {
    ...
    protected void invoke()
        ...
        try {
            ...
            commandMethod = this.getClass().getDeclaredMethod(command, new Class[0]);//クラス指定
            commandMethod.invoke(this, new Object[0]); //メソッドに渡す引数はなし ここで呼び出し
